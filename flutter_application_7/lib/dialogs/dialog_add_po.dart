          ...
          onPressed: () async {
            ...
            try {
              final response = await http.post(
                Uri.parse('http://192.168.1.122:8069/stock_receive_lot'),
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            ...
            try {
              final response = await http.post(
                Uri.parse('http://192.168.1.122:8069/stock_receive_barcode'),
                headers: {"Content-Type": "application/json"},
                body: jsonEncode(payload),
              );
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                try {
                  final response = await http.post(
                    Uri.parse('http://192.168.1.122:8069/stock_receive_sn'),
                    headers: {"Content-Type": "application/json"},
                    body: jsonEncode(payload),
                  );
